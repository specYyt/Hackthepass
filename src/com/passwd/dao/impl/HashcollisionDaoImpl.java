 ...
 *
 */
public class HashcollisionDaoImpl implements HashcollisionDao {
	...
	public SearchResult basic(String query, boolean analyzed, int start, int size) {
		...
		try {
			...
			String ojbectResult = client.getObjectTypesByDB("ntml", "mysql");//通过DBname和DBtype来找对象类型
	...
	/* (non-Javadoc)
	 * @see com.passwd.dao.HashcollisionDao#metatype(java.lang.String, boolean, java.lang.String, java.lang.String, int, int)
	 */
	@Override
